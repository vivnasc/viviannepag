...
// POST (multipart) { ficheiro: PNG, lang: 'pt'|'en' } — guarda a capa tipográfica
// gerada no admin para Os 7 Sinais de Desencaixe, no Supabase. A home usa este
// URL (com fallback para a capa local). Não toca o gerador IA do método.
export async function POST(req: Request) {
  ...
  try {
    ...
    const path = `livro-pilar/os-7-sinais/capa${lang === 'en' ? '-en' : ''}.png`;
