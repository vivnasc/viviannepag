...
// POST — dispara o workflow render-livro-pilar.yml (Puppeteer + pdf-lib) que
...
export async function POST() {
  ...
  const res = await fetch(
    `https://api.github.com/repos/${owner}/${repo}/actions/workflows/render-livro-pilar.yml/dispatches`,
    {
      method: 'POST',
      headers: {
