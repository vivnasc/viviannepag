    ...
    <main className="max-w-[960px] mx-auto px-7 py-12">
      <header className="mb-10">
        ...
        <p className="text-creme-2/60 text-[0.85rem] mt-4 font-serif italic">
          O painel do livro. Por agora, carrega as capas (PT e EN). O manuscrito vive em{' '}
          <span className="not-italic text-creme-2/80">livro_medo/</span> e o interior é tipografado
          por Typst (<span className="not-italic text-creme-2/80">build/livro-medo.typ</span>). O
          render fica para o fim, depois da landing.
        </p>
      </header>
