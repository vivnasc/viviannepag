...
const OUTPUT = path.join(__dirname, '..', 'public', 'produtos', 'ebook-01-culpa-capa.png');
...
<body>
  ...
  <div class="badge">EBOOK · FREEME</div>
  <div class="content">
    <div class="small-gota">${gotaSmall}</div>
    <h1>A culpa não é boa conselheira</h1>
    <p class="sub">Porque te sentes sempre em falta com os teus filhos, e o que essa culpa te está a impedir de fazer.</p>
    <div class="line"></div>
