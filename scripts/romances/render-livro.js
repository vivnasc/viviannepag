...
const PASTAS = {
  ...
  manta: { pt: 'a-manta-livro', en: 'a-manta-livro-en', capa: 'MANTA-capa', outPt: 'A-MANTA-SEM-NOME-pt.pdf', outEn: 'THE-UNSIGNED-BLANKET-en.pdf' },
};
...
const T_PRESENTE = LANG==='pt' ? {
  tituloHtml:'O Presente<br>por Abrir', autora:'Vivianne dos Santos',
  serie:'Biblioteca de Véspera · Estante III · A Mercearia',
  sub:'um romance de Véspera',
  cap:'capítulo',
  sumarioLabel:'Conteúdo', sumario:'Sumário',
  fichaLabel:'Antes de começar',
  ficha:`Esta é uma obra de ficção. Véspera, as suas casas e as suas gentes são imaginadas, e qualquer semelhança com pessoas reais é a semelhança que as histórias verdadeiras têm umas com as outras. Este romance tem um irmão de autoconhecimento: se a Dádiva te doer em sítios reais, o nome do que ela carrega está em «A mulher que tem medo de receber», na coleção Prosperidade. Uma história compreende, mas não substitui acompanhamento: nos temas fundos, procura apoio. Mereces o mesmo cuidado que dás.`,
  finalTit:'Para a leitora',
  finalTxt1:'Obrigada por atravessares este ano de Véspera com a Dádiva. Se a história te tocou, partilha-a, não como prova, mas como semente.',
  finalTxt2:'Encontras os ebooks, os guias e o resto da biblioteca em <a href="https://viviannedossantos.com">viviannedossantos.com</a>.',
  copy:'© 2026 Vivianne dos Santos · viviannedossantos.com',
  registoLabel:'Do registo de Véspera',
} : {
  tituloHtml:'The Unopened<br>Gift', autora:'Vivianne dos Santos',
  serie:'The Véspera Library · Shelf III · The Shop',
  sub:'a novel of Véspera',
  cap:'chapter',
  sumarioLabel:'Contents', sumario:'Contents',
  ...
  finalTit:'For the reader',
  finalTxt1:'Thank you for crossing this year of Véspera with Dádiva. If the story touched you, pass it on, not as proof, but as seed.',
  finalTxt2:'You will find the ebooks, the guides and the rest of the library at <a href="https://viviannedossantos.com">viviannedossantos.com</a>.',
  copy:'© 2026 Vivianne dos Santos · viviannedossantos.com',
  registoLabel:'From the register of Véspera',
};

const T_CASA = LANG==='pt' ? {
  tituloHtml:'A Casa<br>por Acabar', autora:'Vivianne dos Santos',
  serie:'Biblioteca de Véspera · Estante IV · A Ponte',
  sub:'um romance de Véspera',
  cap:'capítulo',
  sumarioLabel:'Conteúdo', sumario:'Sumário',
  fichaLabel:'Antes de começar',
  ficha:`Esta é uma obra de ficção. Véspera, as suas casas e as suas gentes são imaginadas, e qualquer semelhança com pessoas reais é a semelhança que as histórias verdadeiras têm umas com as outras. Este romance tem um irmão de autoconhecimento: se a Esperança te doer em sítios reais, o nome do que ela carrega está em «A mulher que ama o potencial», na coleção SyncHim. Uma história compreende, mas não substitui acompanhamento: nos temas fundos, procura apoio. Mereces o mesmo cuidado que dás.`,
  finalTit:'Para a leitora',
  finalTxt1:'Obrigada por atravessares este ano de Véspera com a Esperança. Se a história te tocou, partilha-a, não como prova, mas como semente.',
  finalTxt2:'Encontras os ebooks, os guias e o resto da biblioteca em <a href="https://viviannedossantos.com">viviannedossantos.com</a>.',
  copy:'© 2026 Vivianne dos Santos · viviannedossantos.com',
  registoLabel:'Do registo de Véspera',
} : {
  tituloHtml:'The Unfinished<br>House', autora:'Vivianne dos Santos',
  serie:'The Véspera Library · Shelf IV · The Bridge',
  sub:'a novel of Véspera',
  cap:'chapter',
  sumarioLabel:'Contents', sumario:'Contents',
  fichaLabel:'Before you begin',
  ficha:`This is a work of fiction. Véspera, its houses and its people are imagined, and any resemblance to real persons is the resemblance true stories bear to one another. This novel has a self-knowledge sibling: if Esperança hurts you in real places, the name of what she carries is in “The Woman Who Loves Potential”, in the SyncHim collection. A story understands, but it does not replace care: in the deep matters, seek support. You deserve the same care you give.`,
  finalTit:'For the reader',
  finalTxt1:'Thank you for crossing this year of Véspera with Esperança. If the story touched you, pass it on, not as proof, but as seed.',
  finalTxt2:'You will find the ebooks, the guides and the rest of the library at <a href="https://viviannedossantos.com">viviannedossantos.com</a>.',
  copy:'© 2026 Vivianne dos Santos · viviannedossantos.com',
  registoLabel:'From the register of Véspera',
};

const T_TROVOADA = LANG==='pt' ? {
  tituloHtml:'A Trovoada', autora:'Vivianne dos Santos',
  serie:'Biblioteca de Véspera · Estante IV · A Ponte',
  sub:'um romance de Véspera',
  cap:'capítulo',
  sumarioLabel:'Conteúdo', sumario:'Sumário',
  fichaLabel:'Antes de começar',
  ficha:`Esta é uma obra de ficção. Véspera, as suas casas e as suas gentes são imaginadas, e qualquer semelhança com pessoas reais é a semelhança que as histórias verdadeiras têm umas com as outras. Este romance tem um irmão de autoconhecimento: se a Tranquilina te doer em sítios reais, o nome do que ela carrega está em «A mulher que confunde intensidade com amor», na coleção SyncHim. Uma história compreende, mas não substitui acompanhamento: nos temas fundos, procura apoio. Mereces o mesmo cuidado que dás.`,
  finalTit:'Para a leitora',
  finalTxt1:'Obrigada por atravessares este ano de Véspera com a Tranquilina. Se a história te tocou, partilha-a, não como prova, mas como semente.',
  finalTxt2:'Encontras os ebooks, os guias e o resto da biblioteca em <a href="https://viviannedossantos.com">viviannedossantos.com</a>.',
  copy:'© 2026 Vivianne dos Santos · viviannedossantos.com',
  registoLabel:'Do registo de Véspera',
} : {
  tituloHtml:'The Thunderstorm', autora:'Vivianne dos Santos',
  serie:'The Véspera Library · Shelf IV · The Bridge',
  sub:'a novel of Véspera',
  cap:'chapter',
  sumarioLabel:'Contents', sumario:'Contents',
...
const T_ESTRANGEIRA = LANG==='pt' ? {
  tituloHtml:'A Estrangeira<br>de Cá', autora:'Vivianne dos Santos',
  serie:'Biblioteca de Véspera · Estante V · A Mesa Comprida',
  sub:'um romance de Véspera',
  cap:'capítulo',
  sumarioLabel:'Conteúdo', sumario:'Sumário',
  fichaLabel:'Antes de começar',
  ficha:`Esta é uma obra de ficção. Véspera, as suas casas e as suas gentes são imaginadas, e qualquer semelhança com pessoas reais é a semelhança que as histórias verdadeiras têm umas com as outras. Este romance tem um irmão de autoconhecimento: se a Peregrina te doer em sítios reais, o nome do que ela carrega está em «A pessoa que não pertence em lado nenhum», na coleção SyncHim. Uma história compreende, mas não substitui acompanhamento: nos temas fundos, procura apoio. Mereces o mesmo cuidado que dás.`,
  finalTit:'Para a leitora',
  finalTxt1:'Obrigada por atravessares este ano de Véspera com a Peregrina. Se a história te tocou, partilha-a, não como prova, mas como semente.',
  finalTxt2:'Encontras os ebooks, os guias e o resto da biblioteca em <a href="https://viviannedossantos.com">viviannedossantos.com</a>.',
  copy:'© 2026 Vivianne dos Santos · viviannedossantos.com',
  registoLabel:'Do registo de Véspera',
} : {
  tituloHtml:'The Foreigner<br>from Here', autora:'Vivianne dos Santos',
  serie:'The Véspera Library · Shelf V · The Long Table',
  sub:'a novel of Véspera',
  cap:'chapter',
  sumarioLabel:'Contents', sumario:'Contents',
  fichaLabel:'Before you begin',
  ficha:`This is a work of fiction. Véspera, its houses and its people are imagined, and any resemblance to real persons is the resemblance true stories bear to one another. This novel has a self-knowledge sibling: if Peregrina hurts you in real places, the name of what she carries is in “The Person Who Belongs Nowhere”, in the SyncHim collection. A story understands, but it does not replace care: in the deep matters, seek support. You deserve the same care you give.`,
  finalTit:'For the reader',
  finalTxt1:'Thank you for crossing this year of Véspera with Peregrina. If the story touched you, pass it on, not as proof, but as seed.',
  finalTxt2:'You will find the ebooks, the guides and the rest of the library at <a href="https://viviannedossantos.com">viviannedossantos.com</a>.',
  copy:'© 2026 Vivianne dos Santos · viviannedossantos.com',
  registoLabel:'From the register of Véspera',
};

const T_CISTERNA = LANG==='pt' ? {
  tituloHtml:'A Cisterna', autora:'Vivianne dos Santos',
  serie:'Biblioteca de Véspera · Estante VI · A Serra',
  sub:'um romance de Véspera',
  cap:'capítulo',
  sumarioLabel:'Conteúdo', sumario:'Sumário',
  fichaLabel:'Antes de começar',
  ficha:`Esta é uma obra de ficção. Véspera, as suas casas e as suas gentes são imaginadas, e qualquer semelhança com pessoas reais é a semelhança que as histórias verdadeiras têm umas com as outras. Este romance tem um irmão de autoconhecimento: se a Soledade te doer em sítios reais, o nome do que ela carrega está em «A mulher que nunca pede», na coleção SyncHim. Uma história compreende, mas não substitui acompanhamento: nos temas fundos, procura apoio. Mereces o mesmo cuidado que dás.`,
  finalTit:'Para a leitora',
  finalTxt1:'Obrigada por atravessares este ano de Véspera com a Soledade. Se a história te tocou, partilha-a, não como prova, mas como semente.',
  finalTxt2:'Encontras os ebooks, os guias e o resto da biblioteca em <a href="https://viviannedossantos.com">viviannedossantos.com</a>.',
  copy:'© 2026 Vivianne dos Santos · viviannedossantos.com',
  registoLabel:'Do registo de Véspera',
} : {
  tituloHtml:'The Cistern', autora:'Vivianne dos Santos',
  serie:'The Véspera Library · Shelf VI · The Mountain',
  sub:'a novel of Véspera',
  cap:'chapter',
  sumarioLabel:'Contents', sumario:'Contents',
  fichaLabel:'Before you begin',
  ...
  finalTit:'For the reader',
  finalTxt1:'Thank you for crossing this year of Véspera with Soledade. If the story touched you, pass it on, not as proof, but as seed.',
  finalTxt2:'You will find the ebooks, the guides and the rest of the library at <a href="https://viviannedossantos.com">viviannedossantos.com</a>.',
  copy:'© 2026 Vivianne dos Santos · viviannedossantos.com',
  registoLabel:'From the register of Véspera',
};

const T_TRAVESSAS = LANG==='pt' ? {
  tituloHtml:'As Travessas<br>Devolvidas', autora:'Vivianne dos Santos',
  serie:'Biblioteca de Véspera · Estante VI · A Serra',
  sub:'um romance de Véspera',
  cap:'capítulo',
  sumarioLabel:'Conteúdo', sumario:'Sumário',
  fichaLabel:'Antes de começar',
  ficha:`Esta é uma obra de ficção. Véspera, as suas casas e as suas gentes são imaginadas, e qualquer semelhança com pessoas reais é a semelhança que as histórias verdadeiras têm umas com as outras. Este romance tem um irmão de autoconhecimento: se a Socorro te doer em sítios reais, o nome do que ela carrega está em «A mulher que não sabe receber ajuda», na coleção SyncHim. Uma história compreende, mas não substitui acompanhamento: nos temas fundos, procura apoio. Mereces o mesmo cuidado que dás.`,
  finalTit:'Para a leitora',
  finalTxt1:'Obrigada por atravessares este ano de Véspera com a Socorro. Se a história te tocou, partilha-a, não como prova, mas como semente.',
  finalTxt2:'Encontras os ebooks, os guias e o resto da biblioteca em <a href="https://viviannedossantos.com">viviannedossantos.com</a>.',
  copy:'© 2026 Vivianne dos Santos · viviannedossantos.com',
  registoLabel:'Do registo de Véspera',
} : {
  tituloHtml:'The Returned<br>Dishes', autora:'Vivianne dos Santos',
  serie:'The Véspera Library · Shelf VI · The Mountain',
  sub:'a novel of Véspera',
  cap:'chapter',
  sumarioLabel:'Contents', sumario:'Contents',
  fichaLabel:'Before you begin',
  ficha:`This is a work of fiction. Véspera, its houses and its people are imagined, and any resemblance to real persons is the resemblance true stories bear to one another. This novel has a self-knowledge sibling: if Socorro hurts you in real places, the name of what she carries is in “The Woman Who Does Not Know How to Receive Help”, in the SyncHim collection. A story understands, but it does not replace care: in the deep matters, seek support. You deserve the same care you give.`,
  finalTit:'For the reader',
  finalTxt1:'Thank you for crossing this year of Véspera with Socorro. If the story touched you, pass it on, not as proof, but as seed.',
  finalTxt2:'You will find the ebooks, the guides and the rest of the library at <a href="https://viviannedossantos.com">viviannedossantos.com</a>.',
  copy:'© 2026 Vivianne dos Santos · viviannedossantos.com',
  registoLabel:'From the register of Véspera',
};
...
const T_MANTA = LANG==='pt' ? {
  tituloHtml:'A Manta<br>Sem Nome', autora:'Vivianne dos Santos',
  serie:'Biblioteca de Véspera · Estante VII · A Fiandeira',
  sub:'um romance de Véspera',
  cap:'capítulo',
  sumarioLabel:'Conteúdo', sumario:'Sumário',
  fichaLabel:'Antes de começar',
  ficha:`Esta é uma obra de ficção. Véspera, as suas casas e as suas gentes são imaginadas, e qualquer semelhança com pessoas reais é a semelhança que as histórias verdadeiras têm umas com as outras. Este romance tem um irmão de autoconhecimento: se a Velada te doer em sítios reais, o nome do que ela carrega está em «A mulher que tem medo de ser vista», na coleção SyncHim. Uma história compreende, mas não substitui acompanhamento: nos temas fundos, procura apoio. Mereces o mesmo cuidado que dás.`,
  finalTit:'Para a leitora',
  finalTxt1:'Obrigada por atravessares este ano de Véspera com a Velada. Se a história te tocou, partilha-a, não como prova, mas como semente.',
  finalTxt2:'Encontras os ebooks, os guias e o resto da biblioteca em <a href="https://viviannedossantos.com">viviannedossantos.com</a>.',
  copy:'© 2026 Vivianne dos Santos · viviannedossantos.com',
  registoLabel:'Do registo de Véspera',
} : {
  tituloHtml:'The Unsigned<br>Blanket', autora:'Vivianne dos Santos',
  serie:'The Véspera Library · Shelf VII · The Spinning Mill',
  sub:'a novel of Véspera',
  cap:'chapter',
  sumarioLabel:'Contents', sumario:'Contents',
  fichaLabel:'Before you begin',
  ficha:`This is a work of fiction. Véspera, its houses and its people are imagined, and any resemblance to real persons is the resemblance true stories bear to one another. This novel has a self-knowledge sibling: if Velada hurts you in real places, the name of what she carries is in “The Woman Who Is Afraid of Being Seen”, in the SyncHim collection. A story understands, but it does not replace care: in the deep matters, seek support. You deserve the same care you give.`,
  finalTit:'For the reader',
  finalTxt1:'Thank you for crossing this year of Véspera with Velada. If the story touched you, pass it on, not as proof, but as seed.',
  finalTxt2:'You will find the ebooks, the guides and the rest of the library at <a href="https://viviannedossantos.com">viviannedossantos.com</a>.',
  copy:'© 2026 Vivianne dos Santos · viviannedossantos.com',
  registoLabel:'From the register of Véspera',
};
...
const T_FERROLHO = LANG==='pt' ? {
  tituloHtml:'O Ferrolho', autora:'Vivianne dos Santos',
  serie:'Biblioteca de Véspera · Estante I · As Casas de Família',
  sub:'um romance de Véspera',
  cap:'capítulo',
  sumarioLabel:'Conteúdo', sumario:'Sumário',
  fichaLabel:'Antes de começar',
  ficha:`Esta é uma obra de ficção. Véspera, as suas casas e as suas gentes são imaginadas, e qualquer semelhança com pessoas reais é a semelhança que as histórias verdadeiras têm umas com as outras. Este romance fala da doença de quem bebe e de quem o ama, com compaixão por ambos e sem receitas. Tem um irmão de autoconhecimento na coleção das mães. Não és responsável pela doença de quem amas, não a curas destruindo-te, e fechar a porta ao mal não é fechar o coração à pessoa. Uma história compreende, mas não substitui acompanhamento: nos temas fundos, e este é fundo, procura apoio. Também tu tens direito a uma casa sem medo.`,
  finalTit:'Para a leitora',
  finalTxt1:'Obrigada por atravessares estas noites de Véspera com a Dores. Se te tocou, partilha-a, não como prova, mas como semente. E se reconheceste em ti alguma porta que devias ter fechado há muito, lembra-te: pôr um limite a quem amamos pode ser mais amor do que todo o sacrifício, e ninguém se salva afogando-se com quem se afunda.',
  finalTxt2:'Encontras os ebooks, os guias e o resto da biblioteca em <a href="https://viviannedossantos.com">viviannedossantos.com</a>.',
  copy:'© 2026 Vivianne dos Santos · viviannedossantos.com',
  registoLabel:'Do registo de Véspera',
} : {
  tituloHtml:'The Bolt', autora:'Vivianne dos Santos',
  serie:'The Véspera Library · Shelf I · The Family Houses',
  sub:'a novel of Véspera',
  cap:'chapter',
  sumarioLabel:'Contents', sumario:'Contents',
  ...
  ficha:`This is a work of fiction. Véspera, its houses and its people are imagined, and any resemblance to real persons is the resemblance true stories bear to one another.`,
  finalTit:'For the reader',
  finalTxt1:'Thank you for crossing these nights of Véspera with Dores.',
  finalTxt2:'You will find the ebooks, the guides and the rest of the library at <a href="https://viviannedossantos.com">viviannedossantos.com</a>.',
  copy:'© 2026 Vivianne dos Santos · viviannedossantos.com',
  registoLabel:'From the register of Véspera',
};
...
const T = LIVRO === 'irma' ? T_IRMA : LIVRO === 'despensa' ? T_DESPENSA : LIVRO === 'presente' ? T_PRESENTE : LIVRO === 'casa' ? T_CASA : LIVRO === 'trovoada' ? T_TROVOADA : LIVRO === 'trave' ? T_TRAVE : LIVRO === 'estrangeira' ? T_ESTRANGEIRA : LIVRO === 'cisterna' ? T_CISTERNA : LIVRO === 'travessas' ? T_TRAVESSAS : LIVRO === 'chave' ? T_CHAVE : LIVRO === 'manta' ? T_MANTA : LIVRO === 'caderno' ? T_CADERNO : LIVRO === 'cheias' ? T_CHEIAS : LIVRO === 'incomodo' ? T_INCOMODO : LIVRO === 'frio' ? T_FRIO : LIVRO === 'fabrica' ? T_FABRICA : LIVRO === 'tradutora' ? T_TRADUTORA : LIVRO === 'sentinela' ? T_SENTINELA : LIVRO === 'ferrolho' ? T_FERROLHO : LIVRO === 'estrada' ? T_ESTRADA : LIVRO === 'portas' ? T_PORTAS : T_AMPARO;
