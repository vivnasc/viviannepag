...
│
└── preview/
    └── index.html         (grelha dos 14 simbolos para revisao)
```
...
>
> Fase 4, revisão. Gera `preview/index.html` com os catorze símbolos numa grelha, editorial e mystic lado a lado por face, com o nome de cada um por baixo, sobre fundo escuro, para eu rever o sistema inteiro de uma vez.
>
