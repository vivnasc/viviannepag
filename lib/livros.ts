...
export const MANUAIS: ManualLivro[] = [
  {
    ...
    dorTitulo: 'Não consegues desligar a cabeça?',
    dorTituloEn: 'Can’t switch your head off?',
  ...
  },
  {
    ...
    dorTitulo: 'Fazes tudo por toda a gente e sentes culpa quando pensas em ti?',
    dorTituloEn: 'Do everything for everyone and feel guilty when you think of yourself?',
  ...
  },
  {
    ...
    dorTitulo: 'Estás sempre à espera que a tua vida comece?',
    dorTituloEn: 'Always waiting for your life to begin?',
