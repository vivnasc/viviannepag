...
const lp_img = `A imagem ENCARNA a frase desta peça: lê a frase e traduz a sua emoção numa IMAGEM ABSTRATA da assinatura (um jogo de luz e sombra, uma textura em grande plano, um vinco, um rasto, um vazio), nunca num objeto bonito ao acaso (regra dura anti-desligado: um fundo bonito sem ligação à frase está ERRADO; mas a ligação faz-se pela sensação, não por ilustrar à letra). Luz suave de manhã. ${METODO_IDENTIDADE} PROIBIDO (banido, em qualquer imagem): teacups or mugs, cups, candles or candle flames or any flame, chairs, women or any person at a window, a person gazing out of a window, people posing, generic wellness or spa or self-help stock imagery, faces, text, halos, auréolas, santos, sacred iconography, dark or gloomy mood. Termina SEMPRE com este sufixo, exatamente: intimate analog film-grain photography, light and shadow and material texture as the subject, soft directional daylight, warm dusty desaturated palette of linen oat cream sand faded terracotta, shallow depth of field, generous negative space, unexpected macro crop, 1970s film look with fine warm grain, no people, no text, vertical 9:16.`;
...
IMAGEM (campo "fundoPrompt", em INGLÊS): a imagem TEM de ENCARNAR a frase desta peça, nunca um objeto bonito ao acaso. Lê a 1.ª linha (a faca) e traduz a sua emoção numa IMAGEM ABSTRATA da assinatura: a luz e a sombra, uma textura ou um material em grande plano, um vinco ou uma dobra, um rasto ou uma marca deixada, algo a meio, um vazio. REGRA DURA (anti-desligado): um fundo bonito que NÃO tenha a ver com a frase está ERRADO; a ligação faz-se pela SENSAÇÃO, não por ilustrar à letra. Sensorial, UM só foco, muito espaço em volta, SEM pessoas, SEM rostos, SEM um catálogo de objetos de casa. ${METODO_IDENTIDADE} PROIBIDO (banido, em qualquer imagem): teacups or mugs, cups, candles or candle flames or any flame, chairs, women or any person at a window, a person gazing out of a window, people posing, generic wellness or spa or self-help stock imagery, faces, text, halos, auréolas, santos, sacred iconography, dark or gloomy mood. Termina SEMPRE com este sufixo, exatamente: intimate analog film-grain photography, light and shadow and material texture as the subject, soft directional daylight, warm dusty desaturated palette of linen oat cream sand faded terracotta, shallow depth of field, generous negative space, unexpected macro crop, 1970s film look with fine warm grain, no people, no text, vertical 9:16.
