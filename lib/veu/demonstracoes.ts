...
export const DEMONSTRACOES: Demonstracao[] = [
  {
    ...
    prompt: 'Cinematic macro close-up of two iridescent soap bubbles of different sizes connected by a thin glass tube on a dark reflective surface. In slow motion the smaller bubble gradually deflates and shrinks while the larger bubble visibly swells and grows, air flowing through the tube. Soft rim light, rainbow shimmer on the film, shallow depth of field, dark moody background, photoreal. No text, no hands, no people. Vertical 9:16.',
  ...
  },
  {
    ...
    prompt: 'Extreme macro close-up of a glass filled to the very brim, water doming and bulging above the rim held by surface tension, tiny coins gently added making the dome rise without spilling. Then a single drop of soap touches the surface and the whole dome collapses and floods over. Soft side light, water highlights, dark background, photoreal, slow motion. No text, no people. Vertical 9:16.',
  ...
  },
  {
    ...
    prompt: 'Cinematic shot of a two-way mirror in a dark room: at first it is a perfect reflective mirror. Slowly a warm light turns on behind it, and the mirror becomes transparent, revealing a quiet human silhouette standing behind the glass that was invisible before. Moody, intimate, soft glow, photoreal, slow reveal. No text. Vertical 9:16.',
  ...
  },
  {
    ...
    prompt: 'Macro close-up of a pool of black ferrofluid resting still on a white surface. A hidden magnet approaches from beneath and the black liquid suddenly rises into sharp living spikes and alien geometric architecture, shifting and breathing. High contrast, glossy black, dramatic light, photoreal, mesmerizing slow motion. No text, no people. Vertical 9:16.',
  ...
  },
  {
    ...
    prompt: 'Cinematic close-up of two acoustic guitars standing side by side in warm light. A single string on the first guitar is plucked and vibrates; then the matching string on the SECOND, untouched guitar begins to vibrate and sing on its own, sympathetic resonance, fine dust trembling on it. Intimate, shallow depth of field, photoreal, slow motion. No text, no hands shown after the pluck. Vertical 9:16.',
  ...
  },
  {
    ...
    prompt: 'Cinematic shot of an old stone arch. Focus on the small keystone at the very top. The small keystone is slowly removed, and the entire heavy stone arch collapses in slow motion, dust rising. Dramatic side light, ancient stone texture, photoreal, weighty slow motion. No text, no people. Vertical 9:16.',
  ...
  },
  {
    ...
    prompt: 'Cinematic close-up of a lit candle with plenty of wax, placed inside a sealed glass jar. The flame slowly dims, shrinks and goes out, not from lack of wax but from lack of oxygen in the closed jar, a thin trail of smoke rising. Warm light fading to dark, intimate, photoreal, slow motion. No text, no people. Vertical 9:16.',
  ...
  },
  {
    ...
    prompt: 'Cinematic close-up of a raw egg held inside a closed fist, squeezed with firm even pressure: the egg does not break, the arched shell distributing the force. Then a single point of pressure or a tiny crack appears and the egg suddenly shatters. Soft dramatic light, photoreal, slow motion. No text. Vertical 9:16.',
  ...
  },
  {
    ...
    prompt: 'Cinematic close-up of a just-extinguished candle with a thin ribbon of smoke rising straight up in still air. A separate flame is brought near the top of the smoke trail (not the wick), and the flame travels DOWN the smoke and reignites the candle. Dark background, warm glow, magical real physics, photoreal, slow motion. No text, no people. Vertical 9:16.',
  ...
  },
  {
    ...
    prompt: 'Mesmerizing macro shot of clear viscous liquid between two cylinders; a single drop of dark ink is injected and slowly stirred until it completely dissolves and disappears into swirls. Then the stirring is reversed and the ink un-mixes, the swirls gathering back together into the original single clean drop. Clinical soft light, high detail, photoreal, slow motion. No text. Vertical 9:16.',
  ...
  },
  {
    ...
    prompt: 'Cinematic close-up of a woven bamboo finger trap with a finger in each end. As the fingers pull apart to escape, the woven tube tightens and grips harder. Then the fingers stop fighting and gently push inward, and the trap loosens and releases. Warm soft light, shallow depth of field, photoreal, slow motion. Vertical 9:16.',
  ...
  },
  {
    ...
    prompt: 'Cinematic top-down macro of a thin metal plate covered with fine sand in chaotic scattered piles. As a pure tone vibrates the plate and the frequency rises to a resonant point, the sand suddenly leaps and self-organizes into a perfect symmetric geometric mandala pattern. Dramatic side light, fine grain detail, photoreal, satisfying slow motion. No text, no people. Vertical 9:16.',
