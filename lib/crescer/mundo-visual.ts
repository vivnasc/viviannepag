...
export const CATEGORIAS: CategoriaVisual[] = [
  ...
  { id: 'retrato', peso: 25, escalas: ['intima'], dica: 'a HUMAN PORTRAIT, recognizably human but with a nervous system no longer braced for danger: a face without vigilance, comparison or hurry, undivided attention, deeply present like a child before defensive socialization, in relation with the world, never posing; older faces are the most sought-after' },
