...
export function slideHTML(opts: { tema?: string; label?: string; texto?: string; idx?: number; total?: number; seed?: string; capa?: boolean; marca?: string; img?: string; imgModo?: string; av?: string; ah?: string; dist?: number; txtSize?: number; geoTop?: number; geoW?: number }): string;
