...
// EN (@viviannewrites): a mesma secção, em inglês natural.
const LABELS_EN = {
  consciencia: 'consciousness', emergencia: 'where we go', eumaior: 'the larger self', transformacao: 'transformation',
  raizes: 'inheritance', sombra: 'shadow', vinculos: 'bonds', campo: "you don't heal alone",
  desencaixe: 'not fitting', sentido: 'meaning', corpo: 'body & presence', ciclos: 'cycles',
};
// handle por língua (a conta-mãe PT e o selo internacional EN).
const HANDLES = { pt: '@vivianne.dos.santos', en: '@viviannewrites' };
const rotuloTema = (tema, lingua) => (lingua === 'en' ? LABELS_EN[tema] : LABELS[tema]) || LABELS[tema] || 'crescer';
...
module.exports = { reelHTML, slideHTML, RECEITAS, receitaDe, motivosDoTema, motivoSVG, geometriaVDS, segmentar, rotuloTema, HANDLES, TOK };
