...
<style>
  ...
  *{ box-sizing:border-box; margin:0; padding:0; }
  ...
  .geo{ position:absolute; top:14%; left:50%; transform:translateX(-50%); width:56%; fill:none; stroke:var(--gold); stroke-linecap:round; }
  circle.ring,.drawpath,.breathe,.cnet line{ stroke-width:.7; fill:none; stroke:var(--gold); }
  .disc{ fill:var(--bg); stroke:var(--gold); stroke-width:1.1; }
  .copy{ position:absolute; left:9%; right:9%; bottom:20%; text-align:center; }
  .rule{ width:44%; height:1px; margin:0 auto 5%; background:linear-gradient(90deg,transparent,var(--gold),transparent); }
  .txt{ font-size:5.4vw; line-height:1.4; }
...
module.exports = { reelHTML, slideHTML, RECEITAS, receitaDe, motivoSVG, segmentar, TOK };
