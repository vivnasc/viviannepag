...
export const CALENDARIO_30_DIAS: ConteudoDia[] = [
  // ═══════════ SEMANA 1: CULPA + FREEME ═══════════
  {
    ...
    slides: [
      ...
      { tipo: 'cta', texto: 'Escrevi sobre isto. 40 páginas. Para a mulher que precisa de ouvir que a culpa tem origem. €7.', bold: ['€7', 'a culpa tem origem'], destaque: 'A culpa não é boa conselheira', fundoClaro: true },
    ],
  },
  {
    dia: 2,
  ...
  },
  {
    ...
    slides: [
      ...
      { tipo: 'cta', texto: 'Há um exercício que te ajuda a separar o que é teu do que carregas pelos outros. 10 minutos. Está no guia. €5.', bold: ['10 minutos', '€5'], destaque: 'O que é meu, o que não é meu', fundoClaro: true },
    ],
  },
  {
    dia: 5,
  ...
  },
  {
    ...
    slides: [
      ...
      { tipo: 'conteudo', texto: 'A culpa. De onde vem. O que te faz. Como começas a largar. 40 páginas. Ebook. €7.', bold: ['A culpa', '€7'], destaque: 'A culpa não é boa conselheira' },
      { tipo: 'conteudo', texto: 'O peso. Exercício para separar o que é teu do que herdaste. 10 minutos que mudam tudo. Guia. €5.', bold: ['O peso', '€5'], destaque: 'O que é meu, o que não é meu' },
      { tipo: 'conteudo', texto: 'Os limites. 7 frases para dizeres não com amor e firmeza. Guia. €5.', bold: ['Os limites', '€5'], destaque: '7 frases para dizer não sem culpa' },
  ...
  // ═══════════ SEMANA 2: HERANÇA + IDENTIDADE ═══════════
  {
    ...
    slides: [
      ...
      { tipo: 'cta', texto: 'Escrevi este ebook para ti. Para a mulher que repete o que jurou não repetir. E quer perceber porquê. €7.', bold: ['para ti', '€7'], destaque: 'O que herdaste sem saber', fundoClaro: true },
    ],
  },
  {
    dia: 9,
