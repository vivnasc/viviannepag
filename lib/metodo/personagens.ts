...
export const FAMILIAS: Familia[] = [
  ...
  },
  {
    ...
    tier: 'nucleo',
    crenca: 'Estou em todo o lado e já não estou em mim.',
    medo: 'Parar e não encontrar ninguém lá dentro.',
    ...
    personagens: [
      ...
      { id: 'desaparecida', nome: 'A Desaparecida', essencia: 'Está em todos os grupos e calendários e perdeu o contacto consigo; diz alto que já não se reconhece (muito nos 40-55).', frases: ['Já nem sei do que gosto.', 'Olho-me ao espelho e não sei quem é.'], sombra: 'Sabe que se perdeu, repete-o, e continua a desaparecer.', veus: ['Desolação', 'Horizonte', 'Permanência'] },
      { id: 'orfa', nome: 'A Órfã', essencia: 'Mesmo rodeada de gente, diz que no fundo está sozinha; desabafa muito e sente-se na mesma.', frases: ['No fundo, estou sozinha.', 'Estou sempre a desabafar e continuo sozinha.'], sombra: 'Nunca acredita totalmente que alguém fique.', veus: ['Dualidade', 'Memória', 'Desolação'] },
      { id: 'rebelde-silenciosa', nome: 'A Insatisfeita', essencia: 'Cumpre tudo e diz a toda a gente que está farta, mas não larga nada; tem tudo e continua inquieta.', frases: ['Estou farta disto tudo.', 'Tenho tudo e continuo inquieta.'], sombra: 'Reclama alto e muda nada.', veus: ['Permanência', 'Horizonte', 'Desolação'] },
    ],
  },
  {
    id: 'adaptar',
