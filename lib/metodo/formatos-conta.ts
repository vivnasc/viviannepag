...
export const FORMATOS_CONTA: Record<ContaId, Record<TipoPeca, FormatoConta>> = {
  ...
  ver: {
    ...
    profundidade: {
      ...
      beats: 5,
      espelho: true,
      registo: 'O ESPELHO (tarde da ver) = REVELAR. A matéria: quem fica a VIVER DENTRO DA CABEÇA de quem vê (quem admira, inveja, detesta, não esquece, quem a irrita ou intimida). [IDEIA INTERNA, só para estruturar, NUNCA escrever no texto: o outro é o espelho, ela é o que lá se reflete.] Não revela quem o outro é, revela PORQUE é que ELA o escolheu. ESTRUTURA: (1) ABRE PARA FORA, aponta para uma figura concreta da vida de quem vê (a colega, a mulher que segue), o murro que para o scroll; (2) APROFUNDA, o comportamento exato, sobe o reconhecimento; (3) VIRA, de fora para dentro (a alma da peça): porque, entre milhões, esta ficou a viver nela; (4) POUSO, frase curta e CONCRETA que liberta, palavra final "revelar" ou nada. MECANISMO (em linguagem da vida, NUNCA teoria nem véu): inveja = a vida que não te deixaste querer; irritação desproporcional = o outro faz o que tu te proíbes; intimidação = a permissão que não te deste; não esquecer = uma frase tua que ficou por dizer. PROIBIDO no TEXTO as palavras-metáfora "vidro", "filme", "espelho", "reflexo", "projeção" (são o nome interno do mecanismo, ficam crípticas para quem lê) — diz sempre em concreto. LINHA VERMELHA: sempre "o outro mostra-te a ti", NUNCA "analisa os outros". Liberta, não bisbilhota. MOLDE: "Há uma mulher que segues só para te irritares. Vê-la mais vezes por dia do que vês quem amas. Não te irrita por ser falsa, irrita-te porque se permite a coisa que tu te proíbes: ocupar espaço sem pedir desculpa. Afinal nunca foi sobre ela. Era sobre o que tu não te deixas." ENVIO: "Manda a quem tem uma pessoa a viver-lhe na cabeça de borla." Veste: espelhos infinitos, máscaras que se desfazem, fios invisíveis tornados visíveis, prismas, véus translúcidos (azul profundo, prata, violeta, branco lunar). Sem rosto, sem voz, texto + imagem que respira.',
    },
  },
  viver: {
    descoberta: {
