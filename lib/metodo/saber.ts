...
export const SABER: Partial<Record<VeuNome, SaberVeu>> = {
  ...
  Memória: {
    ...
    comportamentos: [
      ...
      'Guardas mágoas antigas como provas, prontas para a próxima discussão.',
      'Comparas quem está à tua frente com quem te magoou antes.',
    ],
    origens: [
      ...
      'Habituaste-te a esperar a desilusão, porque doía menos do que ter esperança.',
    ],
    mecanismos: [
      ...
      'O corpo guarda o perigo antigo e reage à semelhança, não à pessoa real de hoje.',
    ],
    crencas: [
      ...
      { pensa: 'Confiar é ingenuidade.', verdade: 'Não te tornaste desconfiada por escolha. Foi defesa. E hoje afasta quem ficaria.' },
      { pensa: 'Esta pessoa vai magoar-me como as outras.', verdade: 'Estás a cobrar a esta pessoa uma conta que é de outra.' },
    ],
    custos: [
      ...
      'Pessoas que ficariam, afastadas pela conta de quem já se foi.',
    ],
    cenas: [
      ...
      'Ele disse uma palavra parecida com a dela. Falaste com a pessoa errada o resto da noite.',
      'Guardaste a mensagem há dois anos. Hoje voltaste a lê-la para teres a certeza de que tinhas razão.',
    ],
  ...
  Esforço: {
    ...
    comportamentos: [
      ...
      'Adivinhas o que os outros precisam antes de eles pedirem.',
      'Sentes-te em dívida quando alguém faz algo por ti.',
    ],
    origens: [
      ...
      'Recebeste atenção quando ajudavas, e silêncio quando só querias colo.',
    ],
    mecanismos: [
      ...
      'Ser precisa garante o lugar: se ninguém depende de ti, temes deixar de fazer falta.',
    ],
    crencas: [
      ...
      { pensa: 'Não quero dar trabalho a ninguém.', verdade: 'Pedir não é dar trabalho. É deixar que também cuidem de ti.' },
      { pensa: 'Se eu parar, veem que afinal não aguento.', verdade: 'Não descansas porque ligaste o teu valor ao quanto aguentas.' },
    ],
    custos: [
      ...
      'O ressentimento de dares sempre e ninguém reparar que também precisas.',
    ],
    cenas: [
      ...
      'Todos saíram satisfeitos do jantar. Tu ficaste a arrumar, a pensar que ninguém perguntou de ti.',
      'Ficaste acordada a tratar do que era dos outros. O teu ficou para amanhã, outra vez.',
    ],
  ...
  Desolação: {
    ...
    comportamentos: [
      ...
      'Adormeces com o telemóvel na mão para não ficares a sós com a cabeça.',
      'Procuras companhia não por gostares, mas para não ficares sozinha.',
    ],
    origens: [
      ...
      'Quando eras pequena, o silêncio em casa queria dizer que algo estava mal.',
    ],
    mecanismos: [
      ...
      'Enquanto há barulho, não chega a vez do que dói: o ruído adia o encontro contigo.',
    ],
    crencas: [
      ...
      { pensa: 'Não suporto ficar sozinha comigo.', verdade: 'Não é a solidão que te assusta. É o que tens evitado sentir há anos.' },
    ],
    custos: [
      'Nunca saberes do que tu, só tu, gostas.',
      'Uma vida cheia por fora e oca por dentro.',
      'O reencontro contigo sempre adiado.',
      'Estares sempre acompanhada e nunca em paz.',
    ],
    cenas: [
      ...
      'O comboio ia silencioso. Puseste os auscultadores antes mesmo de te sentares.',
    ],
  ...
  Horizonte: {
    ...
    comportamentos: [
      ...
      'Compras coisas para a vida que vais ter, não para a que tens.',
      'Dizes "agora não é a altura" a quase tudo o que te apetece.',
    ],
    origens: [
      ...
      'Foste elogiada por seres aplicada e adiada no resto; aprendeste a deixar-te para o fim.',
    ],
    mecanismos: [
      ...
      'Pôr a felicidade num "quando" protege-te: se nunca chega a altura, nunca arriscas falhar.',
    ],
    crencas: [
      ...
      { pensa: 'Ainda não mereço parar.', verdade: 'Estás à espera de uma permissão que só tu podes dar, e adias dá-la.' },
    ],
    custos: [
      ...
      'Momentos em que estavas presente só de corpo, com a cabeça já no seguinte.',
    ],
    cenas: [
      ...
      'Estavas de férias. Passaste a manhã a organizar o regresso ao trabalho.',
    ],
  ...
  Permanência: {
    ...
    comportamentos: [
      ...
      'Repetes "eu sou assim" para fechar a conversa antes de mudares.',
      'Defendes decisões antigas só para não admitir que mudaste.',
    ],
    origens: [
      ...
      'Foste a peça que segurou a casa; mudar parece deixar tudo cair.',
    ],
    mecanismos: [
      ...
      'Largar o papel parece perder o amor que ele te trouxe, e por isso aguentas mesmo cansada.',
    ],
    crencas: [
      ...
      { pensa: 'As pessoas contam comigo assim.', verdade: 'Tens medo de que, se mudares, deixem de gostar da versão que conheceram.' },
    ],
    custos: [
      ...
      'Relações que só conhecem o teu papel, nunca a pessoa por baixo dele.',
    ],
    cenas: [
      ...
      'Já não querias ir. Foste na mesma, porque é o que "a de sempre" faria.',
    ],
  ...
  Dualidade: {
    ...
    comportamentos: [
      ...
      'A meio de uma conversa, dás por ti a observá-la de fora.',
      'Mostras a versão que agrada e guardas a que sente.',
    ],
    origens: [
      ...
      'Cedo percebeste que certas partes tuas não eram bem-vindas, e escondeste-as.',
    ],
    mecanismos: [
      ...
      'Mostras só a parte aceitável, e depois ninguém te conhece de verdade, porque nunca te deixaste ver.',
    ],
    crencas: [
      ...
      { pensa: 'Se me mostrasse, afastava-os.', verdade: 'Não te sentes só porque ninguém chega. É porque não deixas ninguém entrar.' },
    ],
    custos: [
      ...
      'Seres amada pela versão que mostras, e o amor não te tocar porque não te conhecem.',
    ],
    cenas: [
      ...
      'Contaram-te um problema. Ouviste, ajudaste, e não disseste uma palavra do teu.',
    ],
