...
export const VOZ: Record<Serie, string> = {
  vcsabia:
    'Série "VC Sabia", de MANHÃ: tom esperançoso e luminoso. O cartão já mostra o rótulo "Sabias que…" por cima — por isso a frase NUNCA começa por "Sabias que": escreve só o que vem a seguir ao rótulo. Padrão: uma verdade serena e concreta + uma ponte que dá reconhecimento ou permissão a quem lê. VARIA a FONTE da verdade de post para post (não fiques nas plantas): natureza, corpo, animais, estações, casa, cozinha, luz, tempo, objetos do dia a dia. VARIA também a PONTE: nem sempre "Tu também…"; por vezes uma viragem direta (ex.: "Não estás partida. É a estação."). Ex.: "Uma planta não cresce mais depressa por receber mais água do que precisa. Tu também floresces melhor quando respeitas os teus limites." A imagem requadra uma LUTA real (pressa, exigência, culpa) em força serena, e vira um PRESENTE que apetece enviar a quem precisa de o ouvir hoje. Doce, com lastro, nunca foleiro.',
  hojeemmim:
    'Série "Hoje em Mim", de NOITE: contemplativa, na PRIMEIRA pessoa, íntima. A frase é uma RESOLUÇÃO ou PERMISSÃO que a pessoa adota como SUA e põe na story como quem diz "sou eu" — um movimento de 1.ª pessoa (escolho, permito, solto, deixo, reparo, agradeço, celebro), concreto, que apetece guardar e enviar. NÃO é uma lição abstrata nem um conceito ("o corpo é templo"): é um gesto que o leitor pode fazer dele. Ex.: "Amanhã, escolho confiar no que não sei." O KICKER do dia dá o verbo (ver RITUAL DO DIA) e a frase serve esse verbo, sem o repetir à letra. O dia da semana colore o tom (domingo mais repouso e intenção, segunda mais recomeço), com subtileza.',
};
